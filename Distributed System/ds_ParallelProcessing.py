...
class caseProcess(multiprocessing.Process):
    def __init__(self, threadID, fileName, pipe, test = False):
...
class hospitalsProcess(multiprocessing.Process):
    ...
    def run(self):
        ...
        try:
            ...
            hospitalFileName = self.fileName
            ...
            if self.test:
                mem_usage = h.heap()
                f = open('DS_Hosp_Parallel_Mem.txt', 'a+')
                f.write(str(mem_usage.size) + '\n')
                f.close()
...
class inventoryProcess(multiprocessing.Process):
    ...
    def run(self):
        try:
            ...
            inventoryFileName = self.fileName
            ...
            if self.test:
                mem_usage = h.heap()
                f = open('DS_Inven_Parallel_Mem.txt', 'a+')
                f.write(str(mem_usage.size) + '\n')
                f.close()
