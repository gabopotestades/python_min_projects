...
if __name__ == '__main__':
    ...
    if mode == 'S':
        ...
        casesInformationProcess = caseProcess(1, casesFileName)
        hospitalsInformationProcess = hospitalsProcess(2, hospitalFileName)
        inventoryInformationProcess = inventoryProcess(3, inventoryFileName)
